...
constexpr ptrdiff_t dwEntityList = 0x4DD245C;
constexpr ptrdiff_t dwForceAttack = 0x3202970;
constexpr ptrdiff_t dwForceAttack2 = 0x320297C;
constexpr ptrdiff_t dwForceBackward = 0x320291C;
constexpr ptrdiff_t dwForceForward = 0x32029A0;
constexpr ptrdiff_t dwForceJump = 0x527C38C;
constexpr ptrdiff_t dwForceLeft = 0x3202928;
constexpr ptrdiff_t dwForceRight = 0x3202934;
constexpr ptrdiff_t dwGameDir = 0x62B880;
constexpr ptrdiff_t dwGameRulesProxy = 0x52EFBBC;
constexpr ptrdiff_t dwGetAllClasses = 0xDE0764;
constexpr ptrdiff_t dwGlobalVars = 0x58CCC8;
constexpr ptrdiff_t dwGlowObjectManager = 0x531B048;
constexpr ptrdiff_t dwInput = 0x5223A30;
constexpr ptrdiff_t dwInterfaceLinkList = 0x9692B4;
...
constexpr ptrdiff_t dwPlayerResource = 0x3200CC0;
constexpr ptrdiff_t dwRadarBase = 0x52071D4;
...
constexpr ptrdiff_t dwViewMatrix = 0x4DC3D74;
constexpr ptrdiff_t dwWeaponTable = 0x52244F8;
...
constexpr ptrdiff_t find_hud_element = 0x2E2650F0;
...
constexpr ptrdiff_t m_pitchClassPtr = 0x5207470;
