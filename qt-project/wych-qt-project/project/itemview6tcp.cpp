...
ItemView6Tcp::ItemView6Tcp(QWidget *parent)
    : QWidget{parent}
{
    server = nullptr;
    initUI();
...
ItemView6Tcp::~ItemView6Tcp()
{
    stop();
}

void ItemView6Tcp::initUI()
{
...
bool ItemView6Tcp::start(int port, const char *host)
{
...
void ItemView6Tcp::stop()
{
    SAFE_DELETE(server);
}

void ItemView6Tcp::clearConsole()
{
    edtMsg->clear();
}

void ItemView6Tcp::postMessage(const QString& msg)
{
...
void ItemView6Tcp::appendConsole(const QString& msg)
{
...
void ItemView6Tcp::writeConsole(const QString& msg)
{
...
void ItemView6Tcp::customEvent(QEvent *e)
{
    switch (e->type())
    {
    case qEventRecvMsg:
